    ...
    if ! Empty( stmt )
      ...
      for j := 1 to k
        ...
        if 'ZAP' == upper(oXmlNode:title)
          s_kod := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'ID_TEST', , , 'win1251'), 'RU866')
          s_name := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'ID_EL', , , 'win1251'), 'RU866')
          s_nsi_obj := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'NSI_OBJ', , , 'win1251'), 'RU866')
          s_nsi_el := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'NSI_EL', , , 'win1251'), 'RU866')
          s_usl_test := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'USL_TEST', , , 'win1251'), 'RU866')
          s_val_el := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'VAL_EL', , , 'win1251'), 'RU866')
          s_comment :=  hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'COMMENT', , , 'win1251'), 'RU866')
  ...
  if Empty( oXmlDoc:aItems )
    ...
    if ! Empty( stmt )
      ...
      for j := 1 to k
        oXmlNode := oXmlDoc:aItems[1]:aItems[j]
        if 'ZAP' == upper(oXmlNode:title)
          s_kod := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'ID_KTEST', , , 'win1251'), 'RU866')
          s_name := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'NAM_KTEST', , , 'win1251'), 'RU866')
          s_comment := hb_strToUTF8(mo_read_xml_stroke(oXmlNode, 'COMMENT', , , 'win1251'), 'RU866')
          d1 := mo_read_xml_stroke(oXmlNode, 'DATEBEG',)
          d2 := mo_read_xml_stroke(oXmlNode, 'DATEEND',)
          if sqlite3_bind_text( stmt, 1, s_kod ) == SQLITE_OK .AND. ;
